		...
		<div class="container" style="padding-bottom: 50px;">
			<div class="row">
				<div class="col-md-4" style="color: #fff">
					<h3 style="color: #e78b00;"><b>han_store All brand</b></h3>
					<p>Gg. laskar dalam kabupatem bogor,Jawa barat</p>
					<p><i class="glyphicon glyphicon-earphone"></i> +62895343788666</p>
					<p><i class="glyphicon glyphicon-envelope"></i> han_store@gmail.com</p>
				</div>
				<div class="col-md-4">
