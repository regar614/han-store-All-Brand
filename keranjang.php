				...
				if($jml > 0){
					...
					<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
						...
						<tr>
							...
							<td><button type="submit" name="submit1" class="btn btn-warning">Update</button> | <a href="keranjang.php?del=1&id=<?= $row['keranjang']; ?>" class="btn btn-danger" onclick="return confirm('Yakin ingin dihapus ?')"
						</form>
					<?php 
							$sub = $row['hrg'] * $row['jml'];
							$hasil += $sub;
